...
public class M_record extends AppCompatActivity {
    String M_id="";
    int act_page;
    int buy_page;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m_record);
    ...
    public void act_before(View v){
        Intent intent=new Intent(this,M_record.class);
        ...
        public void run() {
            ...
            try {
                ...
                if (conn != null) {
                    ...
                    ResultSet rSet = statement.executeQuery("SELECT B_name,AR_money,AR_date FROM kmbmteam.activity,kmbmteam.activity_record,kmbmteam.business where activity.A_business=activity_record.AR_activity and activity.A_business=business.B_id and AR_member='"+M_id+"' limit "+act_page+",5 ;");
                    Log.v("ha", "遠程連接成功!");
                    x=0;
                    while(rSet.next()) {

                        final String gettext=rSet.getString("B_name")+"\t"+rSet.getString("AR_money")+"\t"+rSet.getString("AR_date");
                    ...
                    rSet = statement.executeQuery("SELECT B_name,P_name,SR_price,SR_date FROM kmbmteam.business,kmbmteam.sale_record,kmbmteam.product where SR_product=p_id and P_business=B_id and SR_member='"+M_id+"' limit "+buy_page+",5;");
                    Log.v("ha", "遠程連接成功!");
                    x=0;

                    while(rSet.next()) {

                        final String gettext=rSet.getString("B_name")+"\t"+rSet.getString("P_name")+"\t"+rSet.getString("SR_price")+"\t"+rSet.getString("SR_date");
